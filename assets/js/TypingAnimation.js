function typing_animation() {
    let text_element = document.querySelector(".text_TA");
    ...
    document.querySelector(".text_cursor_TA").animate([
        {
            opacity: 0
        },
        {
    ...
    if (text_array_slice.length == 1) {
        ...
        let reveal_animation = document.querySelector(".text_hide_TA").animate([
            { left: '0%' },
        ...
        reveal_animation.onfinish = () => {
            setTimeout(() => {
                document.querySelector('.text_hide_TA').animate([
                    {left: '0%'}
                ], {
                    duration: 2000,
